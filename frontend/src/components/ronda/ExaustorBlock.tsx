...
interface ExaustorBlockProps {
  item: { identificador: string };
  value: ExaustorData;
  onChange: (data: ExaustorData) => void;
  falha: boolean;
  observacao: string;
...
export function ExaustorBlock({
  ...
  function set<K extends keyof ExaustorData>(key: K, val: ExaustorData[K]) {
